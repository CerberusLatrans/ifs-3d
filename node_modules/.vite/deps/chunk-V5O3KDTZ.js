...
var we = (t, n, e) => n in t ? ye(t, n, { enumerable: true, configurable: true, writable: true, value: e }) : t[n] = e;
...
function N(t, n) {
  ...
  const r = `_onBeforeCompile${e}`, s = function(o, m) {
    ...
    copy: {
      ...
      configurable: true,
      value: function(o) {
        return t.copy.call(this, o), !t.isShaderMaterial && !t.isDerivedMaterial && (P(this.extensions, o.extensions), P(this.defines, o.defines), P(this.uniforms, UniformsUtils.clone(o.uniforms))), this;
      }
    },
    clone: {
      writable: true,
...
${a}`), { vertexShader: s, fragmentShader: a };
  ...
  return i.customProgramCacheKey = function() {
    return r + "|" + e;
  }, i.isInstancedUniformsMaterial = true, i;
}
...
var Qe = (t) => {
  ...
  return h.type = FloatType, h.minFilter = NearestFilter, h.magFilter = NearestFilter, h.wrapS = ClampToEdgeWrapping, h.wrapT = RepeatWrapping, h.needsUpdate = true, { dataTexture: h, dataWidth: r, dataHeight: s, animMap: o };
};
var qe = () => {
  const t = new BufferGeometry(), n = new Float32Array([
    // top
    0,
    1,
    0,
  ...
  t.setAttribute("position", new BufferAttribute(n, 3));
...
var et = class {
  constructor(n, e, i) {
    ...
    let r = FloatType;
    const s = new Scene(), a = new Camera();
    a.position.z = 1;
    const l = {
      passThruTexture: { value: null }
    }, u = g(x(), l), o = new Mesh(new PlaneGeometry(2, 2), u);
    s.add(o), this.setDataType = function(f) {
      ...
      if (i.capabilities.isWebGL2 === false && i.extensions.has("OES_texture_float") === false)
...
` + p.fragmentShader;
    ...
    this.createShaderMaterial = g, this.createRenderTarget = function(f, c, p, w, y, d) {
      return f = f || n, c = c || e, p = p || ClampToEdgeWrapping, w = w || ClampToEdgeWrapping, y = y || NearestFilter, d = d || NearestFilter, new WebGLRenderTarget(f, c, {
        wrapS: p,
        wrapT: w,
        minFilter: y,
        magFilter: d,
      ...
      const f = new Float32Array(n * e * 4), c = new DataTexture(f, n, e, RGBAFormat, FloatType);
      ...
      i.xr.enabled = false, i.shadowMap.autoUpdate = false, o.material = f, i.setRenderTarget(c), i.render(s, a), o.material = u, i.xr.enabled = w, i.shadowMap.autoUpdate = y, i.setRenderTarget(p);
    };
    function h() {
      return `void main()	{
...
var rt = (t, n) => {
  ...
  s.material.uniforms.instructionsTexture = {
    value: a
  }, s.material.uniforms.spritesheetData = { value: null }, s.material.uniforms.fps = { value: 0 }, s.material.uniforms.deltaTime = { value: 0 }, s.material.uniforms.dataSize = { value: new Vector2() }, i.setVariableDependencies(s, [s]);
  const l = i.init();
  ...
  return {
    ...
    utils: {
      updateAnimationAt: (f, c) => {
        const p = f * 4;
        a.image.data[p] = c, u = true;
      },
      updateOffsetAt: (f, c) => {
        const p = f * 4;
        a.image.data[p + 1] = c, u = true;
      },
      updatePlaymodeAt: (f, c) => {
        const p = f * 4;
        a.image.data[p + 2] = c, u = true;
      },
      updateFrameAt: (f, c) => {
        const p = f * 4;
        a.image.data[p + 3] = c + 10, u = true;
      }
    },
    update: () => {
      u && (a.needsUpdate = true, u = false), i.compute();
    }
  };
};
var st = class {
  constructor() {
    ...
    this._previousTime = 0, this._currentTime = 0, this._startTime = B(), this._delta = 0, this._elapsed = 0, this._timescale = 1, this._useFixedDelta = false, this._fixedDelta = 16.67, this._usePageVisibilityAPI = typeof document < "u" && document.hidden !== void 0, this._usePageVisibilityAPI === true && (this._pageVisibilityHandler = at.bind(this), document.addEventListener(
      "visibilitychange",
...
var Kt = class extends je {
  constructor(e, i, r, s = {
    ...
    _(this, "_timer");
    _(this, "compute");
    REVISION >= 159 ? (this.instanceMatrix.clearUpdateRanges(), this.instanceMatrix.addUpdateRange(0, i * 16)) : this.instanceMatrix.updateRange.count = i * 16, this.instanceColor && (REVISION >= 159 ? (this.instanceColor.clearUpdateRanges(), this.instanceColor.addUpdateRange(0, i * 3)) : this.instanceColor.updateRange.count = i * 3), this.compute = rt(r, i), this._spriteMaterial = l, s.spritesheet && this.updateSpritesheet(s.spritesheet), this._timer = new st(), this._animationMap = /* @__PURE__ */ new Map(), this._spriteMaterial.uniforms.animationData.value = this.compute.gpuCompute.getCurrentRenderTarget(
...
function G(t, n, e) {
  e = e || 2;
  var i = n && n.length, r = i ? n[0] * e : t.length, s = de(t, 0, r, e, true), a = [];
  if (!s || s.next === s.prev)
    return a;
  var l, u, o, m, g, h, x;
...
function F(t, n) {
  ...
  var e = t, i;
  do
    if (i = false, !e.steiner && (Z(e, e.next) || M(e.prev, e, e.next) === 0)) {
...
function mt(t, n, e, i) {
  ...
  for (s = 0, a = n.length; s < a; s++)
    l = n[s] * i, u = s < a - 1 ? n[s + 1] * i : t.length, o = de(t, l, u, i, false), o === o.next && (o.steiner = true), r.push(yt(o));
...
function Mt(t, n) {
  var e = t, i = false, r = (t.x + n.x) / 2, s = (t.y + n.y) / 2;
  do
...
function Y(t, n, e) {
  this.i = t, this.x = n, this.y = e, this.prev = null, this.next = null, this.z = 0, this.prevZ = null, this.nextZ = null, this.steiner = false;
}
...
var kt = class extends BufferGeometry {
  ...
  build() {
    const e = new $t(
      ...
      this.settings,
      this.vertices
    ), i = e.positions.length, r = new BufferAttribute(e.index, 1), s = new BufferAttribute(e.positions, 3), a = new BufferAttribute(Rt(i, [0, 0, 1]), 3), l = new BufferAttribute(e.uv, 2);
...
var Nt = class {
  ...
  async build(n = {}) {
    ...
    if (r.matrixAutoUpdate = false, r.generateMipmaps = false, r.premultiplyAlpha = false, r.wrapS = r.wrapT = RepeatWrapping, r.magFilter = r.minFilter = NearestFilter, r.colorSpace = SRGBColorSpace, i.sheetSize = [a, l], n.makeSlimGeometry) {
      ...
      const d = new CanvasTexture(c);
      d.magFilter = r.minFilter = NearestFilter, d.colorSpace = SRGBColorSpace;
      const v = new kt(
        d,
...
//# sourceMappingURL=chunk-V5O3KDTZ.js.map
